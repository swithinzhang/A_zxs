...
<html>
	<head>
		...
		function showAddPage(){
			location.href="${pageContext.request.contextPath}/speaker/addSpeakera";
		}
      ...
      <tbody>
        <c:forEach items="${speakerList}" var="speaker" varStatus="status">
            <tr>
	          ...
	          <td><a href="#" onclick="return delSpeakerById(this,'${speaker.id}',' ${speaker.speaker_name}')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
           </tr>

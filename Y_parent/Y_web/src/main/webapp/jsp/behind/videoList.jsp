...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<!-- 查询相关组件 -->
				<form class="navbar-form navbar-right" action="${pageContext.request.contextPath}/video/selectlist" method="post" >
						...
						<ul class="dropdown-menu">
							<c:forEach items="${speakerList}" var="speaker">
								<li value='${speaker.id}'><a href="#"
									onclick="showName(this,'${speaker.id}',1)" name="selectSpeakerName">${speaker.speaker_name}</a></li>
							</c:forEach>
						</ul>
						<input type="hidden" name="speakerId" id="speakerId" value="${speaker.id}" />
					</div>
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<c:forEach items="${courseList}" var="course">
								<li value="${course.id}"><a href="#"
									onclick="showName(this,${course.id},2)" name="selectCourseTitle">${course.course_title}</a></li>
							</c:forEach>
						</ul>
	...
	<div class="container">
		<div class="navbar-right" style="padding-right: 17px">
			<p:page url="${pageContext.request.contextPath}/video/list" bean="page"></p:page>
		</div>
	</div>
</body>
</html>
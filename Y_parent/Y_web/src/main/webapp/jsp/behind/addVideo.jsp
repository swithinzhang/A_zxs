...
<c:if test="${videomessage!=null}">
    <h1>${videomessage}</h1>
    <%
        session.removeAttribute("videomessage");
    %>
</c:if>
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/video/saveOrUpdate" method="post">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    ...
                    <c:if test="${not empty video.course_id}">
                        <input type="hidden" class="form-control" id="courseId" name="courseId" value="${video.course_id}">
                    </c:if>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="url" name="imageUrl" class="form-control" value="${video.image_url}" placeholder="具体的url">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="url" name="videoUrl" class="form-control" value="${video.video_url}" placeholder="具体的url">
            </div>
        </div>

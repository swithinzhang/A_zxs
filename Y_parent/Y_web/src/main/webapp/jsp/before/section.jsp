...
<head>
    ...
    $(function(){
        ...
        //通过ajax更新播放次数
        var params= {"videoId":"1","playNum":"1"};
...
<body class="w100">
        ...
        <div class="container">
            <span>欢迎来到小禅院！</span>
	            ...
	            <div id="userBlock" style="display:none;float:right">
	               ...
	               <a href="${pageContext.request.contextPath}/user/showMyProfile" id="account">${emailName}</a>
	            </div>
    ...
    <nav class="w100">
        <div class="container">
            <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo" onclick="location.href='course.jsp'" draggable="false">
            <ul class="text_13 f_right">
                <li>
                    <a href="${pageContext.request.contextPath}/course/index" target="_blank">首页</a>
                </li>
                <li class="nav_down">
                ...
                <li id="gkk" class="nav_choose">
                    <a href="${pageContext.request.contextPath}/course/findCourse" target="_blank">在线公开课</a>
                </li>
                <li>
                    <a href="http://www.chengjian100.com/zhuanjiashizi/index.html" target="_blank">专家师资</a>
                </li>
                <li><a href="${pageContext.request.contextPath}/course/littleTemple" target="_blank">小禅院新闻</a></li>
            </ul>
        </div>
    </nav>
    <div id="detail"></div>
        ...
        <div>
            <!--面包屑导航-->
            <div class="container mian-nav"></div>
            ...
            <div class="intro">
                <div class="container">
                    <div class="v-intro">
                        <div class="left">
                            <video id="videoPlayer" src="${video[0].video_url}" class="video-js vjs-default-skin" controls width="627" height="280"
                                poster="${video[0].image_url}" data-setup="{}">
                            </video>
                        </div>

                        <div class="right">
                            <p class="right-title">${video[0].title}</p>
                            <div class="avatar">
                                <span style="background-image: url(${sessionScope.speaker[0].head_img_url})"></span>
                                <p><b>讲师：${sessionScope.speaker[0].speaker_name}</b><br><i>${sessionScope.speaker[0].speaker_desc}</i></p>
                            </div>
                            <p class="video-intro">
                                <span>本节内容：</span> ${video[0].detail}
                            </p>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <c:forEach items="${video}" var="video" >
	                    <div class="chapter"  onclick="load(${video.id})">
	                        <p class="biaoti"><a href="showVideo?videoId=${video.id}&subjectName=${subject[0].subject_name}">${video.title}</a></p>
	                        <p class="lecturer">${video.detail}</p>
	                        <p class="lecturer">讲师：${speaker[0].speaker_name}</p>
	                        <div class="v-info">
	                            <span class="count"><img src="${pageContext.request.contextPath}/img/count.png" alt="">${video.play_num}</span>

...
<body class="w100">
    ...
    <nav class="w100">
        <div class="container">
            ...
            <ul class="text_13 f_right">
                <li>
                    <a href="${pageContext.request.contextPath}/course/index" >首页</a>
                </li>
                <li class="nav_down">
                ...
                <li id="gkk" class="nav_choose">
                    <a href="${pageContext.request.contextPath}/course/findCourse">在线公开课</a>
                </li>
                <li>
                    <a href="#">专家师资</a>
                </li>
    ...
    <div id="app" >
        <!--banner图-->
        <div class="banner" style="background-image: url(${pageContext.request.contextPath}/img/banner-1.jpg)"></div>

        <!--面包屑导航-->
        <div class="container mian-nav">课程介绍</div>
        ...
        <div class="classify">
            <div class="container">
                ...
                <c:forEach items="${course}" var="course">
                    ...
                    <div class="kcIntro">
                        <p class="int"><span>课程介绍：</span>${course.course_desc}</p>
                    </div>
                    <ul>
                        <!--节-->
                        <c:forEach items="${video}" var="video" varStatus="i" >
                                 <li class="section-main"  onclick="getVideo(${video.id})">
		                            ...
		                            <div class="classify-v-info">
		                                <span class="count" title="观看次数"><img src="${pageContext.request.contextPath}/img/count.png" alt="">${video.play_num}</span>

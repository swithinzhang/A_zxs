        ...
        <menu>
            <div class="container clearfix">
                <ul class="clearfix f_left">
                    <li><a href="${pageContext.request.contextPath}/course/index">首页</a></li>
                    <li><a href="${pageContext.request.contextPath}/course/findCourse">课程</a></li>
                    <li><a href="#">关于我们</a></li>
                ...
                <div id="user_bar">
                    <a href="user/showMyProfile">
                      ...
                      <c:if test="${not empty user.imgUrl}">
                         <img id="avatar" src="http://10.8.152.57:8081/Show/${user.imgUrl}" alt="">
                      </c:if>
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <c:if test="${empty user.imgUrl}">
		                      ...
		                      <c:if test="${not empty user.imgUrl}">
		                         <img id="avatar" width="180px" heigth="180px" src="http://10.8.152.57:8081/Show/${user.imgUrl}" alt="">
		                      </c:if>
                            <p>

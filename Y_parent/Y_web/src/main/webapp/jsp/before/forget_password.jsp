        ...
        <div class="container">
            <form class="ma" action="${pageContext.request.contextPath}/user/validateEmailCode">
                <div class="form_header">
                    ...
                    <div class="form_back">
                        <a href="${pageContext.request.contextPath}/course/index">返回立即登录</a>
                    </div>
                </div>
                <div class="form_body">
                ...
                <c:if test="${youxiangmessage!=null}">
                    <h1>${youxiangmessage}</h1>
                    <%
                        session.removeAttribute("youxiangmessage");
                    %>
                </c:if>

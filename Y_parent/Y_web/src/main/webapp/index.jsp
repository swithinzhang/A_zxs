        ...
        <div class="container">
            <span>欢迎来到Y先生教育！</span>
	            ...
	            <div id="userBlock" style="display:none;float:right">
	               ...
	               <a href="javascript:;" id="loginout" onclick="loginout()">退出</a>
...
<%--                    onmousemove="showCourseList()--%>
                ...
                <li>
                    <a href="https://baike.baidu.com/item/%E4%B8%93%E5%AE%B6/3369419">专家师资</a>
                </li>
                
                <li><a href="https://www.douban.com/group/topic/18755530/" >Y先生新闻</a></li>
                <li class="nav_last">
                    <a href="https://www.douban.com/note/376230291/" >关于Y先生</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/findCourse">
    ...
    <div class="form_area">
        <div class="container">
            ...
            <form id="iform" action="user/apply" method="post">
